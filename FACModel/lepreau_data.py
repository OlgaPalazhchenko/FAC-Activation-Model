...
hot_leg_length = [32, 166, 99.4, 182.6, 96, 99, 96, 98.17]
cold_leg_length = [136, 95, 99, 97, 144.77, 65.4, 92, 66, 42, 32]


number_tubes = [8, 11, 14, 15, 18, 19, 20, 21, 22, 23, 24, 27, 28, 28, 28, 29, 28, 31, 32, 33, 34, 35, 36, 35, 36, 37,
                36, 39, 38, 39, 40, 41, 40, 36, 40, 43, 42, 43, 44, 43, 44, 45, 42, 45, 46, 45, 46, 47, 46, 47, 48, 47,
                48, 43, 48, 48, 50, 49, 50, 49, 50, 51, 50, 51, 50, 51, 52, 51, 52, 50, 46, 51, 52, 53, 52, 53, 52, 53,
                52, 53, 52, 53, 50, 50, 48, 48, 47]
...
def steam_generator_properties(SteamGenerator):
    ...
    for Bundle, length, i in zip(SteamGenerator, u_bend_total, number_tubes):
        ...
        Bundle.TubeNumber = i
        Bundle.SludgeThickness = [0.001] * Bundle.NodeNumber
