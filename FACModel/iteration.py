...
ACTIVATION_ENERGY_ALLOY800 = 295024.3034
ACTIVATION_ENERGYH2onALLOY800 = 284072.5252
...
def FAC_solver(Section, ConstantRate):
    ...
    # preset desired FAC rate
        ...
        rate = [1.8e-09, 2.6e-09, 1.8e-09, 1.50e-09, 1.50e-09, 1.50e-09, 1.50e-09, 8.00e-10, 1.5e-09]
